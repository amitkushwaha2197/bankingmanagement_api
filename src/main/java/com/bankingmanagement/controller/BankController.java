...
public class BankController {
    ...
    // http://localhost:8080/api/v1/banks/23  PUT
    @PutMapping("/{bankCode}")
    public ResponseEntity<BankTO> updateBank(
            @PathVariable int bankCode,
            @RequestBody @Valid BankRequest bankRequest) throws BankDetailsNotFoundException {
        BankTO updatedBank = bankService.updateBank(bankCode, bankRequest);
