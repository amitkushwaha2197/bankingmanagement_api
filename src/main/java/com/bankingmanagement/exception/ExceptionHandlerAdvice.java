...
public class ExceptionHandlerAdvice {
    ...
    @ResponseStatus(value = HttpStatus.NOT_FOUND)
    public ExceptionResponse handleBranchException(BranchDetailsNotFoundException ex, HttpServletRequest request){
    ...
    @ResponseStatus(value = HttpStatus.NOT_FOUND)
    public ExceptionResponse handleAccountException(AccountDetailsNotFoundException ex, HttpServletRequest request){
    ...
    @ResponseStatus(value = HttpStatus.NOT_FOUND)
    public ExceptionResponse handleCustomerException(CustomerDetailsNotFoundException ex, HttpServletRequest request){
    ...
    @ResponseStatus(value = HttpStatus.NOT_FOUND)
    public ExceptionResponse handleLoanException(LoanDetailsNotFoundException ex, HttpServletRequest request){
